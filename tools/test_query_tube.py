...
def main():
    ...
    import json
    with open("/mnt/lustre/jkyang/wxpeng/CVPR23/PVSG_Image/data/pvsg_demo/video_names.json", "r") as f:
    ...
    for video_name in video_names:
        ...
        save_root = osp.join("/mnt/lustre/jkyang/wxpeng/CVPR23/PVSG_Image/work_dirs/test_default_ckpt4_tracking_and_save_qf2", video_name)
