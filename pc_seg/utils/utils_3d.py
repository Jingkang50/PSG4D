...
class Instance(object):
    ...
    def __init__(self, mesh_vert_instances, instance_id):
        ...
        self.label_id    = int(self.get_label_id(instance_id)) #semantic label
        self.vert_count = int(self.get_instance_verts(mesh_vert_instances, instance_id)) # instance points number
