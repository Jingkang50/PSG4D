...
class Dataset:
    ...
    def trainLoader(self):
        self.train_file_names = sorted(glob.glob(os.path.join("/mnt/lustre/share/jkyang/psg4d/dataset_jcenaa/dataset/sailvos3d/data_3d_10_train", '*' + 'pth')))
    ...
    def valLoader(self):
        self.val_file_names = sorted(glob.glob(os.path.join("/mnt/lustre/share/jkyang/psg4d/dataset_jcenaa/dataset/sailvos3d/data_3d_10_val", '*' + 'pth')))
    ...
    def testLoader(self):
        self.test_file_names = sorted(glob.glob(os.path.join("/mnt/lustre/share/jkyang/psg4d/dataset_jcenaa/dataset/sailvos3d/data_3d_10_val", '*' + 'pth')))
        # self.test_file_names = sorted(glob.glob(os.path.join("/mnt/lustre/share/jkyang/psg4d/dataset_jcenaa/dataset/sailvos3d/data_3d_debug", '*' + 'pth')))
        # self.test_file_names = sorted(glob.glob(os.path.join("/mnt/lustre/share/jkyang/psg4d/dataset_jcenaa/dataset/sailvos3d/data_3d_track_example", '*' + 'pth')))
        # import random
        # self.test_file_names = random.sample(self.test_file_names, int(len(self.test_file_names) / 100))
