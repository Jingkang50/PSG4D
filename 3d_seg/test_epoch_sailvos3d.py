...
import random
import os
from utils_sailvos3d import utils
        ...
        for i, data in enumerate(dataloader):
            ...
            if (epoch > cfg.prepare_epochs):
                ...
                for i, idx in enumerate(data['id']):
                    test_scene_name = dataset.test_file_names[int(data['id'][0])]
                    # test_scene_name = dataset.images_path[int(data['id'][0])].split('/')[-3] + dataset.images_path[int(data['id'][0])].split('/')[-1][:-4]
