...
def main():
    ...
    # process images per video and connect tracker ---- video-by-video processing...............................
    # import json
    # with open("/mnt/lustre/wxpeng/PSG4D/data/GTA/psg4d_0514.json", "r") as f:
    #     anno = json.load(f)
    video_names = ['fam_1_ext_alt2', 'mic_4_int', 'family_4_mcs_3_concat', 'maude_mcs_5', 
                   'sol_1_mcs_1_concat', 'maude_mcs_3', 'maude_mcs_2', 'maude_mcs_4', 'family_2_mcs_2', 
                   'fam_6_mcs_1', 'fin_c_ext', 'fbi_2_mcs_2', 'fam_1_mcs_2']
    #video_names = ['demo'] # for demo
    total_num_tubes_previous = 0 # init (track_id among all videos)
    for video_name in video_names:
        ...
        save_root = osp.join("/mnt/lustre/wxpeng/PSG4D/work_dirs/gta_rgbd_test_save_qf_train_only", video_name)
        if not osp.exists(save_root):
            os.makedirs(save_root)

        num_tubes_this_video = eval_seq(data_cfg=cfg.data.test,
                                        tracker_cfg=cfg.tracker_cfg,
                                        outputs=outputs,
                                        classes=dataset_single_video.CLASSES,
                                        save_root=save_root,
                                        total_num_tubes_previous=total_num_tubes_previous)
