...
class Mask2FormerCustomRGBD(SingleStageDetector):
    ...
    def simple_test(self, imgs, img_metas, dep_img, **kwargs):
        ...
        """
        blocks, merges = self.extract_feat(imgs, dep_img[0]) # after backbone + neck
        mask_cls_results, mask_pred_results, query_feats= self.panoptic_head.simple_test_with_query(
            merges, img_metas, **kwargs) # modify -- use simple_test_with_query to return que_fea with mask!
