...
from .mask import MaskAssociationTracker

def eval_seq(opt, dataloader, result_filename, save_dir=None, # for every sequence
...
if __name__ == '__main__':
    ...
    if not opt.test:
        seqs_str = '''MOTS20-02
                      ...
                      MOTS20-11
                    '''
        data_root = '{}/train'.format(opt.mots_root)
    else:
        seqs_str = '''MOTS20-01
                      MOTS20-06
                      MOTS20-07
                      MOTS20-12
                    '''
        data_root = '{}/test'.format(opt.mots_root)
